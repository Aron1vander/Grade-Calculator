...
enum D3TK_Data {
    static func create() -> Jurusan {
        ...
        let matkul1A = MataKuliah(nama: "Dasar Sistem Komputer", sks: 3, semester: semester1)
        matkul1A.komponen = [KomponenNilai(nama: "Praktikum", bobot: 100, mataKuliah: matkul1A)]

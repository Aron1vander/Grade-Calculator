...
enum S1TM_Data {
    static func create() -> Jurusan {
        ...
        let matkul1A = MataKuliah(nama: "Pengantar Metalurgi", sks: 3, semester: semester1)
        matkul1A.komponen = [KomponenNilai(nama: "Analisis Material", bobot: 100, mataKuliah: matkul1A)]

...
enum S1TE_Data {
    static func create() -> Jurusan {
        let jurusan = Jurusan(nama: "S1 - Teknik Elektro")
        let semester1 = Semester(nomor: 1, jurusan: jurusan)
        let matkul1A = MataKuliah(nama: "Rangkaian Listrik I", sks: 3, semester: semester1)
        matkul1A.komponen = [KomponenNilai(nama: "Desain Rangkaian", bobot: 100, mataKuliah: matkul1A)]

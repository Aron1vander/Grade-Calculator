...
enum S1MR_Data {
    static func create() -> Jurusan {
        ...
        let matkul1A = MataKuliah(nama: "Manajemen Proyek", sks: 3, semester: semester1)
        matkul1A.komponen = [KomponenNilai(nama: "Studi Kasus", bobot: 100, mataKuliah: matkul1A)]
        semester1.mataKuliah = [matkul1A]

        let matkul1B = MataKuliah(nama: "Manajemen", sks: 3, semester: semester1)
        matkul1A.komponen = [KomponenNilai(nama: "Studi Kasus", bobot: 100, mataKuliah: matkul1A)]
        semester1.mataKuliah = [matkul1A]
        
        let matkul1C = MataKuliah(nama: "Akuntansi", sks: 3, semester: semester1)
        matkul1A.komponen = [KomponenNilai(nama: "Studi Kasus", bobot: 100, mataKuliah: matkul1A)]
        semester1.mataKuliah = [matkul1A]
